...
public class MailMessageConnectorGetProfileTest extends AbstractIntegrationTest {
    ...
    public void testGetProfile1() {
        try {
            ...
            RepositoryProfile repositoryProfile1 = 
                (RepositoryProfile)connector.getMessageBySubject("Groups2", profileKey1.toJSON().toString());
    ...
    @Test
    public void testGetProfile50() {
        try {
            long tm = System.currentTimeMillis();
            ProfileKey profileKey50 = createProfileKey(50);
            Profile profile50 = createProfile(50);
            RepositoryProfile repositoryProfile50 = 
                (RepositoryProfile)connector.getMessageBySubject("Groups1", profileKey50.toJSON().toString());
    ...
    @Test
    public void testGetProfile75() {
        try {
            long tm = System.currentTimeMillis();
            ProfileKey profileKey75 = createProfileKey(75);
            Profile profile75 = createProfile(75);
            RepositoryProfile repositoryProfile75 = 
                (RepositoryProfile)connector.getMessageBySubject("Groups1", profileKey75.toJSON().toString());
    ...
    @Test
    public void testGetProfile300() {
        try {
            long tm = System.currentTimeMillis();
            ProfileKey profileKey300 = createProfileKey(300);
            RepositoryProfile repositoryProfile300 = 
                (RepositoryProfile)connector.getMessageBySubject("Groups1", profileKey300.toJSON().toString());
